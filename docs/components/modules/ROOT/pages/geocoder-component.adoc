...
|===
| Name | Description | Default | Type
| *address* | The geo address which should be prefixed with <tt>address: |  | String
| *latlng* | The geo latitude and longitude which should be prefixed with <tt>latlng: |  | String
|===
